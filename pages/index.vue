    ...
    <section class="gird grid-rows-8 col-span-12 md:col-span-8 place-self-center">
      ...
      <div class="flex row-span-7 min-h-48 h-1/2 place-self-center place-items-center text-neutral-100">
        ...
        <ul class="flex flex-col justify-center">
          ...
          <li v-show="slide_number == 2" id="slide-2" aria-label="about me"
            :class="`transition duration-3 ${fade_animation}`">
            <!-- SLIDE 2: ABOUT ME-->
          ...
          <!-- SLIDE 3: EDUCATIONS -->
          <li v-show="slide_number == 3" id="slide-3" aria-label="Educations"
            :class="`Nunito md:min-w-96 transition duration-3 ${fade_animation}`">
          ...
          <!-- SLIDE 4: EXPERIENCES -->
          <li v-show="slide_number == 4" id="slide-4"
            :class="`Nunito space-y-2 transition duration-3 ${fade_animation}`">
      ...
      <div class="row-span-1 mt-4">
        <ul class="flex Nunito justify-center space-x-5 cursor-pointer">
          ...
          <li class="text-slate-200 font-mono text-sm space-x-2 hover:font-bold active:space-x-0"
            v-on:click="SliderLogic('2')">
            <span>[</span>
            <span>2</span>
            <span>]</span>
          </li>
          <li class="text-slate-200 font-mono text-sm space-x-2 hover:font-bold active:space-x-0"
            v-on:click="SliderLogic('3')">
            <span>[</span>
            <span>3</span>
            <span>]</span>
          </li>
